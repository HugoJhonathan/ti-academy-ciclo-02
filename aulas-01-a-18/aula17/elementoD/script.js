window.onload = function() {
    ...
    (() => {
        ...
        for (let pro of produtos) { // vai ler o array um de cada vez, pro = {descrição: 'nome', preço:33}
            const filhoLi = document.createElement('li');

            for (listaP in pro) { // ListaP = descricao, preco
                console.log(listaP);
                if (listaP == 'preco') {
        ...
        Total.value = totazinho.toLocaleString('pt-BR', { style: 'currency', currency: 'BRL' });
